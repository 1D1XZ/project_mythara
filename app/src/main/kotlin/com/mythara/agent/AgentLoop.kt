                ...
                ChatMessage(
                    ...
                    content =
                        "AUTO-REPLY MODE — you are composing a reply to ${parsed.contact} for the user, on the user's behalf, without asking the user first. They've trusted you with this contact.\n\n" +
                            ...
                            "  2. DO NOT tap on any image, link, or media in the chat. DO NOT open photos full-screen. DO NOT scroll up beyond the visible window. DO NOT navigate beyond reading what's already on screen. The chat-default view is enough context — anything past that is unnecessary disruption.\n" +
                            ...
                            "  5. Compose ONE short reply in the user's voice. Match the tone you saw in the screenshot_view description. If an image was in it, reference what's IN it naturally ('cute dog!', 'that view is something else') — not 'I see you sent a photo'.\n" +
                ...
                ChatMessage(
                    ...
                    content =
                        "AUTO-TRIAGE MODE — a message arrived from someone NOT in the user's favorites. You decide whether it deserves a reply. The default answer is NO; only reply on real conversational messages from real people.\n\n" +
                            ...
                            "       c. read_screen is ONLY for finding tap coordinates if you need to enter a chat from the list. Never use it as a substitute for screenshot_view when you want to know what's in the conversation.\n" +
                            "       d. DO NOT tap on any image, link, or media in the chat. DO NOT open photos full-screen. DO NOT scroll beyond the visible window. DO NOT follow any URL — the URL-safety rule above is absolute.\n" +
