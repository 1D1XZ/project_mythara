...
class ToolRegistry @Inject constructor(
    ...
    scheduleAgentTaskTool: com.mythara.agent.tools.ScheduleAgentTaskTool,
    listScheduledTasksTool: com.mythara.agent.tools.ListScheduledTasksTool,
    cancelScheduledTaskTool: com.mythara.agent.tools.CancelScheduledTaskTool,
    rememberTool: com.mythara.agent.tools.RememberTool,
    readProfileTool: com.mythara.agent.tools.ReadProfileTool,
    updateProfileInsightTool: com.mythara.agent.tools.UpdateProfileInsightTool,
    getTaskStatusTool: com.mythara.agent.tools.GetTaskStatusTool,
    getToolCallHistoryTool: com.mythara.agent.tools.GetToolCallHistoryTool,
    ...
    private val nativeTools: List<Tool> = listOf(
        ...
        rememberTool,
        readProfileTool,
        updateProfileInsightTool,
        getTaskStatusTool,
        getToolCallHistoryTool,
        manageFavoritesTool,
        triggerActionTool,
